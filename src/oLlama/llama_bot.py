...
from src.ref.personality import personality_dict as p_dict
from src.ref.personality import occupation_dict as o_dict
from src.ref.personality import setting_dict as s_dict
